...
func MustMakeChainConfigFromDb(ctx *cli.Context, db ethdb.Database) *core.ChainConfig {
	...
	// Display DOB support message
	current := fmt.Sprintf("GPG is configured to support DOB")
	howtosync := fmt.Sprintf("After the hard-fork block 150000 passed, changing chains requires a resync from scratch!")
